...
[travis-badge]: https://travis-ci.org/filipesilva/angular-avam-gui-layout.svg?branch=master
[travis-badge-url]: https://travis-ci.org/filipesilva/angular-avam-gui-layout
...
1. Create a project folder (you can call it `avam-gui-layout` and rename it later).
...
```
git clone https://github.com/filipesilva/angular-avam-gui-layout.git
cd angular-avam-gui-layout
npm install
npm start
```
...
### Download
[Download the QuickStart Library seed](https://github.com/filipesilva/angular-avam-gui-layout/archive/master.zip)
...
Use your editor to search the project for all instances of `avam-gui-layout` and change it
